export default {
  ...
  homepage: {
    project_name: '"JednoŚladami Andersa" scout&guide bike relay',
    travel_project_during_which: '"JednoŚladami Andersa" is a travel project during which riders take part in a bike relay following the route of General Anders’ army starting from the lower course of the Volga river in western Siberia up to Edinburgh, the UK and Gdańsk, Poland.',
    the_project_has_been: 'The project has been initiated and is organized by participants of the Bike Jamboree, i.e. a world bike relay that took place from 2017 to 2019 with the organizational support of the World Jamboree Foundation, the Polish Scouting and Guiding Association and the Afryka Nowaka Association.',
  ...
  about_the_project: {
    ...
    travel_project_during_which: '"JednoŚladami Andersa" is a travel project during which riders take part in a bike relay following the route of the General Anders’ army which was formed in the Orenburg Oblast in the middle course of the Volga river in 1941.',
    the_project_aims_at: 'The project aims at gaining a more profound knowledge of the story behind the General Anders’ Army. We intent to do so by means of a bike relay.',
    formula: 'Formula',
    the_core_of_the_project: 'The core of the project was to cover the marching route of the army from Tatishchevo, Russia up to Edinburgh, the UK. However, due to the current political situation we were forced to make some changes to the relay starting point. We plan to ride through the countries marked with Anders’ Army footsteps. We commence the ride in the lower course of the Volga river in western Siberia; then will move on through Kazakhstan to Uzbekistan and from there through Turkmenistan to Turkmenbashi at the Caspian Sea. From there we will take the sea route, just like the Army did, to Tehran. After that we will ride through Iran to Iraq and then through Jordan and Israel to Egypt. The Mediterranean Sea will take us to southern Italy where riders will participate in the commemoration of the anniversary of the Battle of Monte Casino. From there riders will reach Milan where they will separate. Some will go up to Edinburgh, where the Anders’ Army went with Wojtek the Bear. The others will ride to the Sobieszewo Island, the site of the 2027 World Scout Jamboree. The relay is planned to finish simultaneously and symbolically in 2 places.',
    the_main_route_covers_over: 'The main route covers over 15.000km and is divided into 14 stages, each with 6 riders.',
    initiators: 'Initiators',
    the_expedition_has_been_initiated: 'The expedition has been initiated and organized by participats of the Bike Jamboree, i.e. a world bike relay that took place from 2017 to 2019 with the organizational support of the World Jamboree Foundation, the Polish Scouting and Guiding Association and the Afryka Nowaka Association.',
    value_of_the_project: 'Value of the project',
    the_planned_budget_exceeds: 'The planned budget exceeds PLN 2 million, which comprises among others the cost of travelling, equipment and programme both domestically and abroad. The project is financed by the foundation, relay riders, sponsors, as well as with the help of subsidies.',
    dates: 'Dates',
    although_the_project_itself: 'Although the project itself commences in 2022 with a series of activities to commemorate the events from 80 years ago, you’ll have the opportunity to spot us already in 2021 in a few places close to the heart of every scout and guide in Poland.',
    the_relay_itself_sets: 'The relay itself sets off in November 2022 so that in May 2023 it can participate in the commemoration of the anniversary of the Battle of Monte Casino and in July 2023 it can finally reach Edinburgh.',
    due_to_the_changing_geopolitical: 'Due to the changing geopolitical and epidemiological circumstances the framework of the project may undergo some changes bearing in mind the safety and wellbeing of its participats.',
  ...
  people: {
    people: 'People',
    project_is_organized_by_number: 'The "JednoŚladami Andersa" project is organized by a number of individuals highly valued both in the travelling and scout&guide circles. The core members of the team comprise the following individuals:',
    hes_been_an_active_scout: 'He’s been an active scout member for over 25 years. Throughout this time he’s been a leader and a troops commander in Augustów as well as a member of the Chief Council of the Polish Scouting and Guiding Association, a member of the Polish contingent commands for the 18th World Scout Jamboree in the Netherlands and the 21st World Scout Jamboree in the UK, a Polish Scouting and Guiding Association treasurer as well as a member of the Headquarters of the Polish Scouting and Guiding Association (2007-2009) and a member of the Council of the Głodówka Polish Scouting and Guiding Foundation (2008-2016).',
    ...
    apart_from_the_above: 'Apart from the above Magda also…works as a coordinator of international and digital projects; she trains other people how to use computers and new media and deals with promotional projects and the media.',
    where_is_a_bike: 'Where is the bike in all of this? She’s been riding it for 12 years, every day, the whole year, no matter what the weather’s like.',
    magda_took_part: 'Magda took part in the 34th BJ stage from Barcelona to Geneva through the Pyrenees and the Alps.',
    in_the_jednosladami_andersa: 'In the "Jednośladami Andersa" project she’s responsible for promotion and information, i.e. communication with the media, film production, graphic support for other areas, social media and the website.',
    every_day_she_uses: 'Every day she uses her strength, ambitions and knowledge working with renewable energy sources. She sleeps best when she travels or when she intends to do so. She belives in the power of challenges and overcoming one’s obstacles. She’s an organizer and initiator. Sometimes she engages in creating rhymes too. She’s a fan of mountain hiking and sitting by the fire and outdoor trips far away from civilisation. Monika is a no-matter-the-weather bike freak.',
    she_belives_in_mark_twain: 'She believes in Mark Twain’s quote: "Twenty years from now you will be more disappointed by the things that you didn’t do than by the ones you did do. So thrown off the bowlines. Sail away from the safe harbor. Catch the trade winds in your sails. Explore. Dream. Discover"',
    in_bike_jamboree_around: 'In Bike Jamboree Around the World 2017-2019 she was the leader of the prolonged 15th stage to the world’s end, responsible for casting the relay stick into the sea. She took part in the 26th stage through breathtaking national parks in the US',
    in_the_project_shes_responsible: 'In the project she’s responsible for inspiring, joyful and unlimited human resources &lt;3.',
    for_him_impossible_becomes: 'For him "impossible becomes possible”. In the Polish Scouting and Guiding Association he’s climbed the career ladder from a cub to the association spokesperson (2007-2010).',
  ...
  join_us: {
    join_us: 'Join us',
    there_are_several_options: 'There are several options to join the "JednoŚladami Andersa" project',
    ride_a_bike_in_the_relay: 'Ride a bike in the relay',
    engage_in_the_programme: 'Engage in the programme',
    suggest_your_own_element: 'Suggest your own element to enrich the project that commemorates the achievements of the Polish army.',
    registration: 'Registration',
    currently_we_are_seeking_riders: 'Currently we are seeking riders for the following stages:',
    stage: 'Stage',
    route: 'Route',
    date: 'Date',
    contact: 'Contact'
  ...
  previous_projects: {
    ...
    not_intending_to_boast: 'Not intending to boast but we believe to have what it takes to organize intercontinental bicycle relays. It is indeed a narrow specialization but we do know the ropes.',
    a_bike_relay_the_world: 'A bike relay the world hasn’t seen! Around the world!',
    from_poland_through_europe: 'From Poland through Europe, Asia Minor, the Middle East, Central Asia, China up to Japan!',
    following_the_footsteps_of: 'Following the footsteps of Kazimierz Nowak',
    expedition_website: 'Expedition website'
  },
  contact: {
    contact: 'Contact',
    the_project_stuff_are: 'The project staff are all volunteers working remotely not only from different parts of Poland but from other countries as well. If you have any questions drop us a line via email:',
