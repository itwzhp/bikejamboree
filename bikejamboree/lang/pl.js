export default {
  ...
  stages: {
    ...
    stage_vi: 'Etap VI',
    stage_vii: 'Etap VII',
    stage_vii_sea: 'Etap VII Sea',
    stage_viii: 'Etap VIII',
    stage_ix: 'Etap IX',
    stage_x_west: 'Etap X West',
    stage_xi_west: 'Etap XI West',
    stage_x_east: 'Etap X East',
    stage_xi_east: 'Etap XI East',
    stage_xii_east: 'Etap XII East',
  },
  navigation: {
  ...
  footer: {
    project_name: 'Harcerska sztafeta rowerowa "JednoŚladami Andersa"',
  },
  homepage: {
    project_name: 'Harcerska sztafeta rowerowa "JednoŚladami Andersa"',
  ...
  about_the_project: {
    about_the_project: 'O projekcie',
    travel_project_during_which:
      '"JednoŚladami Andersa" to projekt podróżniczy, który polegał na przejechaniu w sztafecie rowerowej szlaku armii gen. Andersa, która formowała się na terenie obwodu orenburskiego w środkowym biegu Wołgi od 1941 roku.',
    the_project_aims_at:
    ...
    the_core_of_the_project:
      'Trzonem projektu miało być przejechanie trasy przemarszu wojsk od Tatiszczewa w Rosji, gdzie formowało się polskie wojsko, aż do Edynburga w Wielkiej Brytanii, gdzie Korpus został rozformowany. Jednak sytuacja polityczna zmusiła nas do skorygowania miejsca startu sztafety. Naszą trasę rozpoczęliśmy ostatecznie 12 listopada 2022r. w kazachstańskiej Astanie. Następnie jechaliśmy przez kolejne kraje znaczone śladami Armii Andersa, czyli Uzbekistan, Iran, Irak, Jordanię i Izrael. Następnie sztafeta wróciła do Polski, by po chwili dotrzeć do Taranto w południowych Włoszech i przebyć trasę w kierunku północy. W połowie maja wzięliśmy udział w obchodach rocznicy Bitwy pod Monte Casino. Po uroczystościach rowerzyści dotarli do Mediolanu. W tym mieście nasza wyprawa rozdzieliła się na trasę wschodnią i zachodnią. Trasa zachodnia powiodła nas do Edynburga [Szkocja], gdzie dotarły wojska Andersa wraz z Niedźwiedziem Wojtkiem. Trasa wschodnia powiodła nas, przez Szwajcarię, Austrię, Czechy do Gdańska [Polska], gdzie w 2027 odbędzie się Światowe Jamboree. Sztafeta zakończyła się 8 lipca 2023 r., równolegle w dwóch miejscach na świecie.',
    the_main_route_covers_over:
      'Główna trasa liczyła ponad 15 tys. km i została podzielona na 14 etapów rowerowych, które były pokonywane zwykle w sześcioosobowych zespołach. Przez 9 miesięcy 76 osób uczestniczących w projekcie jako członkowie etapów odwiedzili 15 krajów i ponad 150 miejsc pamięci narodowej.',
    relay_is_the_main: 'Sztafeta stanowiła kulminacyjny element większego projektu, gdyż już od 11 listopada 2021 realizowaliśmy programy pomocnicze w ramach, których zrealizowaliśmy:',
    activity_one: 'Rowerową Sztafetę Betlejemskiego Światła Pokoju 2021 i 2022,',
    activity_two: 'wyKręconą Lilijkę - czyli rowerowy Dzień Myśli Braterskiej 2022,',
  ...
  route: {
    route: 'Trasa',
    choose_stage_from_the_list: 'Wybierz etap z listy',
    or: 'lub',
    start_from_the_beginnig: 'Zacznij od początku (Etap I)',
    legend: 'Legenda',
    show_legend: 'Pokaż legendę',
    hide_legend: 'Ukryj Legendę',
    start_astana: 'Start - Astana',
    finish_edinburgh_gdansk: 'Meta - Edynburg, Gdańsk',
    stage_change_locations: 'Miejsca zmiany etapów',
    route_of_the_expedition: 'Trasa wyprawy',
    start: 'start',
    finish: 'meta',
    distance: 'dystans',
    leader: 'lider',
    show_full_route: 'Pokaż całą trasę',
  },
  people: {
    people: 'Ludzie',
    project_is_organized_by_number:
      'W organizację projektu JednoŚladami Andersa zaangażowanych jest wiele osób cenionych w środowisku podróżniczym i harcerskim. Trzon zespołu stanowią:',
  ...
  join_us: {
    ...
    ride_a_bike_in_the_relay: 'Pojedź w sztafecie',
    engage_in_the_programme: 'Weź udział w inicjatywie programowej',
    suggest_your_own_element:
      'Zaproponuj własny element wzbogacający projekt upamiętniający dokonania polskiej armii.',
    registration: 'Rekrutacja',
    currently_we_are_seeking_riders: 'Aktualnie trwa rekrutacja na etapy:',
    stage: 'Etap',
    route: 'Trasa',
    date: 'Data',
    contact: 'Kontakt',
  ...
  previous_projects: {
    our_previous_projects: 'Poprzednie projekty ',
    not_intending_to_boast:
      'Jakkolwiek nieskromnie by to nie zabrzmiało, jesteśmy ekspertami w organizacji międzykontynentalnych sztafet rowerowych. Specjalizacja to, owszem, dość wąska, za to naprawdę znamy się na tym, co robimy.',
    a_bike_relay_the_world:
      'Rowerowa sztafeta, jakiej jeszcze nie było. Dookoła świata!',
    from_poland_through_europe:
      'Z Polski przez Europę, Azję Mniejszą, Bliski Wschód, Azję Centralną, Chiny, aż do Japonii!',
    following_the_footsteps_of: ' Sztafeta śladami Kazimierza Nowaka.',
    expedition_website: 'Strona wyprawy',
  },
  contact: {
    contact: 'Kontakt',
    the_project_stuff_are:
      'W sztabie projektu pracujemy wolontariacko, zdalnie i z całej Polski, a nawet bywa, że i ze świata. Zatem, jeśli masz pytanie, zachęcamy do napisania do nas maila.',
    on_the_internet_you: 'W internecie znajdziesz nas na:',
  },
}
